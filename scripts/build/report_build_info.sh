...
echo "app.appName=${APP_NAME}"
echo "app.buildVersion=${VERSION}"
echo "app.buildAppVersion=${BUILD_GIT_REVISION}"
echo "app.buildStatus=${tree_status}"
echo "app.buildTag=${GIT_DESCRIBE_TAG}"
echo "app.buildUser=$(whoami)"
echo "app.buildHost=$(hostname -f)"
echo "app.buildTime=$(date '+%Y-%m-%d--%T')"
